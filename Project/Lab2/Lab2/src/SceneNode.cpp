...
namespace EngineSceneNode {
	...
	SceneNode::SceneNode() {
		localMatrix = mathsMatFactory::matFactory::createIdentityMat4();
		worldMatrix = mathsMatFactory::matFactory::createIdentityMat4();
		...
		scale = mathsMatFactory::matFactory::createIdentityMat4();
		state;
		stateI;
		stateF;
